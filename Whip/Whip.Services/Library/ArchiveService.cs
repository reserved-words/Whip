...
namespace Whip.Services
{
    public class ArchiveService : IArchiveService
    {
        ...
        private readonly IDirectoryNamer _directoryNamer;
        ...
        public bool ArchiveTracks(List<Track> tracks, out string errorMessage)
        {
            ...
            _playlistsService.RemoveTracks(tracks);
            _libraryService.RemoveTracks(_library, tracks);
            _playlist.RemoveTracks(tracks);
            return true;
        }
        ...
        private bool ArchiveFiles(List<Track> tracks, out string errorMessage)
        {
            ...
            foreach (var track in tracks)
            {
                ...
                var artistDirectory = _directoryNamer.GetArtistDirectoryName(track);
                var albumDirectory = _directoryNamer.GetAlbumDirectoryName(track);
